...
export INC="clib8.h"
#export FFLAGS=" -O3 -qnosave -qintsize=8 -qrealsize=8 -qmoddir=../w3_8 -I /nwprod/lib/incmod/sigio_4 -I /nwprod/lib/incmod/w3_8"
export FFLAGS=" -O3 -qnosave -qintsize=8 -qrealsize=8 -qmoddir=../../incmod/w3_8 -I../../incmod/w3_8"
export AFLAGS=" -X64"
export CFLAGS=" -O3 -q64"
make -f make.libw3
#
...
export INC="clibd.h"
export FFLAGS=" -O3 -qnosave -qrealsize=8 -qmoddir=../../incmod/w3_d -I ../../incmod/w3_d"
export AFLAGS=" -X64"
export CFLAGS=" -O3 -q64"
make -f make.libw3
