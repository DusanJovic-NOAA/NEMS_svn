...
!
      call esmf_cplcompsetentrypoint(gc_atm_cpl                         &  
                                    ...
                                    ,rc)
!
      call atmos_err_msg(rc,'set entry point for coupler initialize',rc_reg)
!
!-----------------------------------------------------------------------
...
!
      call esmf_cplcompsetentrypoint(gc_atm_cpl                         &  
                                    ...
                                    ,rc)
!
      call atmos_err_msg(rc,'set entry point for coupler run',rc_reg)
!
!-----------------------------------------------------------------------
...
!
      call esmf_cplcompsetentrypoint(gc_atm_cpl                         &  
                                    ...
                                    ,rc)
!
      call atmos_err_msg(rc,'set entry point for coupler finalize',rc_reg)
!
!-----------------------------------------------------------------------
!***  check the error signal variable.
!-----------------------------------------------------------------------
!
      call atmos_err_msg_final(rc_reg,'set coupler services step',rc)
!
!-----------------------------------------------------------------------
!
...
!
!-----------------------------------------------------------------------
      call atmos_err_msg_final(rcfinal,'main cpl initialize step',rc)
!
      rc_cpl=rcfinal
!
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
!
      call atmos_err_msg_final(rcfinal,'main cpl run step',rc)
!
      rc_cpl=rcfinal
!
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
!
      call atmos_err_msg_final(rcfinal,'main cpl finalize step',rc)
!
      rc_cpl=rcfinal
!
!-----------------------------------------------------------------------
