!!!!!  ==========================================================  !!!!!
!!!!!            sw-rrtm1 radiation package description            !!!!!
!!!!!  ==========================================================  !!!!!
!                                                                      !
!   the sw-rrtm1 package includes these parts:                         !
!                                                                      !
!      'radsw_rrtm1_param.f'                                           !
!      'radsw_rrtm1_datatb.f'                                          !
!      'radsw_rrtm1_main.f'                                            !
!                                                                      !
!   the 'radsw_rrtm1_param.f' contains:                                !
!                                                                      !
!      'module_radsw_parameters'  -- band parameters set up            !
!      'module_radsw_cntr_para'   -- control parameters set up         !
!                                                                      !
!   the 'radsw_rrtm1_datatb.f' contains:                               !
!                                                                      !
...
!                                                                      !
!   the 'radsw_rrtm1_main.f' contains:                                 !
!                                                                      !
...
!                                                                      !
!      'swrad'      -- main rrtm1 sw radiation routine                 !
!         inputs:                                                      !
...
!
!     character(24), parameter :: VTAGSW='RRTM-SW 224v1   mar 2004'
!     character(24), parameter :: VTAGSW='RRTM-SW 224v2.3 mar 2005'
      character(24), parameter :: VTAGSW='RRTM-SW 224v2.3 Apr 2007'
...
!    2005-03-15   y.-t. hou, ncep,        modified to use aer's rrtmg-sw!
...
!    2003-02-27  jean-jacques morcrette, ecmwf   original author        !
!    2004-01-20  yu-tai hou    modified for ncep models                 !
!    2005-03-15  yu-tai hou    modified delta scaling                   !
!                                                                       !
!  *******************************************************************  !
!
      implicit none
