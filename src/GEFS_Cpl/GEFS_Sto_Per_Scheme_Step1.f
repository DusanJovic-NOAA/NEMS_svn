...
!--------------------------------------
 ...
 CALL GetF90ArrayFromState(impGEFS, 'pps', cst%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'psm', cst%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'tt', cst%work2, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'tm', cst%work2, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'uu', cst%work2, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'um', cst%work2, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'vv', cst%work2, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'vm', cst%work2, 0, rc = rc1)
 ...
 IF(rc == ESMF_SUCCESS) THEN
     PRINT*, "PASS: GEFS_Sto_Per_Scheme_Step1_2"
 ELSE
     PRINT*, "FAIL: GEFS_Sto_Per_Scheme_Step1_2"
 END IF
