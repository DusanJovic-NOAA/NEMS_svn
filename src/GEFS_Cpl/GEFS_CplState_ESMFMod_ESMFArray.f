...
!--------------------------------------
 ...
 CALL GetF90ArrayFromState(impGEFS, 'tt', Cpl_Int_State%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'uu', Cpl_Int_State%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'vv', Cpl_Int_State%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'sshum', Cpl_Int_State%work1, 0, rc = rc1)

     IF(ESMF_LogMsgFoundAllocError(rc1, "Get From impGEFS to the Cpl Internal State -- q.")) THEN
         rcfinal = ESMF_FAILURE
         PRINT*, 'Error Happened When Getting From impGEFS to the Cpl Internal State -- q, rc = ', rc1
         rc1 = ESMF_SUCCESS
     END IF
 ...
 CALL GetF90ArrayFromState(impGEFS, 'ooz', Cpl_Int_State%work1, 0, rc = rc1)

     IF(ESMF_LogMsgFoundAllocError(rc1, "Get From impGEFS to the Cpl Internal State -- OZ.")) THEN
         rcfinal = ESMF_FAILURE
         PRINT*, 'Error Happened When Getting From impGEFS to the Cpl Internal State -- OZ, rc = ', rc1
         rc1 = ESMF_SUCCESS
     END IF
 ...
 CALL GetF90ArrayFromState(impGEFS, 'ccld', Cpl_Int_State%work1, 0, rc = rc1)

     IF(ESMF_LogMsgFoundAllocError(rc1, "Get From impGEFS to the Cpl Internal State -- CLW.")) THEN
         rcfinal = ESMF_FAILURE
         PRINT*, 'Error Happened When Getting From impGEFS to the Cpl Internal State -- CLW, rc = ', rc1
         rc1 = ESMF_SUCCESS
     END IF
 ...
 CALL GetF90ArrayFromState(impGEFS, 'tm', Cpl_Int_State%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'um', Cpl_Int_State%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'vm', Cpl_Int_State%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'shumm', Cpl_Int_State%work1, 0, rc = rc1)

     IF(ESMF_LogMsgFoundAllocError(rc1, "Get From impGEFS to the Cpl Internal State -- q(-DT).")) THEN
         rcfinal = ESMF_FAILURE
         PRINT*, 'Error Happened When Getting From impGEFS to the Cpl Internal State -- q(-DT), rc = ', rc1
         rc1 = ESMF_SUCCESS
     END IF
 ...
 CALL GetF90ArrayFromState(impGEFS, 'ozm', Cpl_Int_State%work1, 0, rc = rc1)

     IF(ESMF_LogMsgFoundAllocError(rc1, "Get From impGEFS to the Cpl Internal State -- OZ(-DT).")) THEN
         rcfinal = ESMF_FAILURE
         PRINT*, 'Error Happened When Getting From impGEFS to the Cpl Internal State -- OZ(-DT), rc = ', rc1
         rc1 = ESMF_SUCCESS
     END IF
 ...
 CALL GetF90ArrayFromState(impGEFS, 'cldm', Cpl_Int_State%work1, 0, rc = rc1)

     IF(ESMF_LogMsgFoundAllocError(rc1, "Get From impGEFS to the Cpl Internal State -- CLW(-DT).")) THEN
         rcfinal = ESMF_FAILURE
         PRINT*, 'Error Happened When Getting From impGEFS to the Cpl Internal State -- CLW(-DT), rc = ', rc1
     END IF
 ...
 CALL GetF90ArrayFromState(impGEFS, 'tt6', Cpl_Int_State%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'uu6', Cpl_Int_State%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'vv6', Cpl_Int_State%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'sshum6', Cpl_Int_State%work1, 0, rc = rc1)

     IF(ESMF_LogMsgFoundAllocError(rc1, "Get From impGEFS to the Cpl Internal State -- q(-6H).")) THEN
         rcfinal = ESMF_FAILURE
         PRINT*, 'Error Happened When Getting From impGEFS to the Cpl Internal State -- q(-6H), rc = ', rc1
         rc1 = ESMF_SUCCESS
     END IF
 ...
 CALL GetF90ArrayFromState(impGEFS, 'ooz6', Cpl_Int_State%work1, 0, rc = rc1)

     IF(ESMF_LogMsgFoundAllocError(rc1, "Get From impGEFS to the Cpl Internal State -- OZ(-6H).")) THEN
         rcfinal = ESMF_FAILURE
         PRINT*, 'Error Happened When Getting From impGEFS to the Cpl Internal State -- OZ(-6H), rc = ', rc1
         rc1 = ESMF_SUCCESS
     END IF
 ...
 CALL GetF90ArrayFromState(impGEFS, 'ccld6', Cpl_Int_State%work1, 0, rc = rc1)

     IF(ESMF_LogMsgFoundAllocError(rc1, "Get From impGEFS to the Cpl Internal State -- CLW(-6H).")) THEN
         rcfinal = ESMF_FAILURE
         PRINT*, 'Error Happened When Getting From impGEFS to the Cpl Internal State -- CLW(-6H), rc = ', rc1
     END IF
 ...
 CALL GetF90ArrayFromState(impGEFS, 'tm6', Cpl_Int_State%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'um6', Cpl_Int_State%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'vm6', Cpl_Int_State%work1, 0, rc = rc1)
 ...
 CALL GetF90ArrayFromState(impGEFS, 'shumm6', Cpl_Int_State%work1, 0, rc = rc1)

     IF(ESMF_LogMsgFoundAllocError(rc1, "Get From impGEFS to the Cpl Internal State -- q(-6H-DT).")) THEN
         rcfinal = ESMF_FAILURE
         PRINT*, 'Error Happened When Getting From impGEFS to the Cpl Internal State -- q(-6H-DT), rc = ', rc1
         rc1 = ESMF_SUCCESS
     END IF
 ...
 CALL GetF90ArrayFromState(impGEFS, 'ozm6', Cpl_Int_State%work1, 0, rc = rc1)

     IF(ESMF_LogMsgFoundAllocError(rc1, "Get From impGEFS to the Cpl Internal State -- OZ(-6H-DT).")) THEN
         rcfinal = ESMF_FAILURE
         PRINT*, 'Error Happened When Getting From impGEFS to the Cpl Internal State -- OZ(-6H-DT), rc = ', rc1
         rc1 = ESMF_SUCCESS
     END IF
 ...
 CALL GetF90ArrayFromState(impGEFS, 'cldm6', Cpl_Int_State%work1, 0, rc = rc1)

     IF(ESMF_LogMsgFoundAllocError(rc1, "Get From impGEFS to the Cpl Internal State -- CLW(-6H-DT).")) THEN
         rcfinal = ESMF_FAILURE
         PRINT*, 'Error Happened When Getting From impGEFS to the Cpl Internal State -- CLW(-6H-DT), rc = ', rc1
     END IF
...
!------------------------------------
     CALL ESMF_StateGet(impGEFS, 'pps', ESMFArray1, rc = rc1)
...
!------------------------------------
     CALL ESMF_StateGet(impGEFS, 'tt', ESMFArray2, rc = rc1)
...
!---------------------------------------------------------------------
     CALL AddF90ArrayToState(expGEFS, grid2, "tt",   Cpl_Int_State%tw,   rc = rc1)
     ...
     CALL AddF90ArrayToState(expGEFS, grid2, "sshum",   Cpl_Int_State%qw,   rc = rc1)

         IF(ESMF_LogMsgFoundError(rc1, "Add q to expGEFS")) THEN
             rcfinal = ESMF_FAILURE
             PRINT*, 'Error Happened When Adding q to expGEFS, rc = ', rc1
             rc1 = ESMF_SUCCESS
         END IF

     CALL AddF90ArrayToState(expGEFS, grid2, "ooz",  Cpl_Int_State%ozw,  rc = rc1)

         IF(ESMF_LogMsgFoundError(rc1, "Add oz to expGEFS")) THEN
             rcfinal = ESMF_FAILURE
             PRINT*, 'Error Happened When Adding oz to expGEFS, rc = ', rc1
             rc1 = ESMF_SUCCESS
         END IF

     CALL AddF90ArrayToState(expGEFS, grid2, "ccld", Cpl_Int_State%clww, rc = rc1)

         IF(ESMF_LogMsgFoundError(rc1, "Add clw to expGEFS")) THEN
             rcfinal = ESMF_FAILURE
             PRINT*, 'Error Happened When Adding clw to expGEFS, rc = ', rc1
             rc1 = ESMF_SUCCESS
         END IF

     CALL AddF90ArrayToState(expGEFS, grid2, "uu",   Cpl_Int_State%uw,   rc = rc1)
     ...
     CALL AddF90ArrayToState(expGEFS, grid2, "vv",   Cpl_Int_State%vw,   rc = rc1)
     ...
     CALL AddF90ArrayToState(expGEFS, grid1, "pps",  Cpl_Int_State%psw,  rc = rc1)
...
!------------------------------------------------------------------
     CALL AddF90ArrayToState(expGEFS, grid2, "tm",   Cpl_Int_State%twm,   rc = rc1)
     ...
     CALL AddF90ArrayToState(expGEFS, grid2, "shumm",   Cpl_Int_State%qwm,   rc = rc1)

         IF(ESMF_LogMsgFoundError(rc1, "Add shumm to expGEFS")) THEN
             rcfinal = ESMF_FAILURE
             PRINT*, 'Error Happened When Adding shumm to expGEFS, rc = ', rc1
             rc1 = ESMF_SUCCESS
         END IF

     CALL AddF90ArrayToState(expGEFS, grid2, "ozm",  Cpl_Int_State%ozwm,  rc = rc1)

         IF(ESMF_LogMsgFoundError(rc1, "Add ozm to expGEFS")) THEN
             rcfinal = ESMF_FAILURE
             PRINT*, 'Error Happened When Adding ozm to expGEFS, rc = ', rc1
             rc1 = ESMF_SUCCESS
         END IF

     CALL AddF90ArrayToState(expGEFS, grid2, "cldm", Cpl_Int_State%clwwm, rc = rc1)

         IF(ESMF_LogMsgFoundError(rc1, "Add cldm to expGEFS")) THEN
             rcfinal = ESMF_FAILURE
             PRINT*, 'Error Happened When Adding cldm to expGEFS, rc = ', rc1
             rc1 = ESMF_SUCCESS
         END IF

     CALL AddF90ArrayToState(expGEFS, grid2, "um",   Cpl_Int_State%uwm,   rc = rc1)
     ...
     CALL AddF90ArrayToState(expGEFS, grid2, "vm",   Cpl_Int_State%vwm,   rc = rc1)
     ...
     CALL AddF90ArrayToState(expGEFS, grid1, "psm",  Cpl_Int_State%pswm,  rc = rc1)
