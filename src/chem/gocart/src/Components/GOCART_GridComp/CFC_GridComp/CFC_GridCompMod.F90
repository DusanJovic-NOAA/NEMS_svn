...
!------------------ A T T E N T I O N !!!!!!! --------
! Disabled the CFC run method because forecasts were blowing up on the
! weekend June 28, 2008. This is meant to be temporary while we investigate 
! problem further.
!                     Arlindo.daSilva@nasa.gov
!
      IF(MAPL_AM_I_ROOT()) THEN
       print *,'WARNING: CFC component run method temporarily disabled'
      END IF
      RC = 0
      RETURN
