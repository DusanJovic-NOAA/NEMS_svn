!  $Id: MAPL_VarSpecMod.F90,v 1.16 2008/09/11 20:03:12 trayanov Exp $
...
interface MAPL_VarSpecPrint
   module procedure MAPL_VarSpecPrint
...
! Sanity checks
  ...
  subroutine MAPL_VarSpecSet(SPEC, SHORT_NAME, LONG_NAME, UNITS,       &
  ...
  end subroutine MAPL_VarSpecSet
  ...
  subroutine MAPL_VarSpecGet(SPEC, SHORT_NAME, LONG_NAME, UNITS,       &
  ...
  end subroutine MAPL_VarSpecGet
...
! check for a match
  ...
  subroutine MAPL_VarSpecPrint(SPEC, RC )
...
!    CALL WRITE_PARALLEL(trim(string))
    ...
    RETURN_(ESMF_SUCCESS)
  end subroutine MAPL_VarSpecPrint
