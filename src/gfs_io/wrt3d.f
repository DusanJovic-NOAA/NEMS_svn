      SUBROUTINE WRT3D(IOPROC,no3d,nblck,ZHOUR,FHOUR,IDATE,colat1,
...
!!
     ...
     &,       idq3a(7), idq3b(9), icmf(3)
      ...
      data    idu3/247, 181, 183, 196/   !! Grib table has no value for gravity
      data    idv3/248, 182, 184, 197/   !! wave drag and cumulus momentum mixing!
      data    icc/213/, icmf/231,231,231/
!
...
!
!     integer kmsk(lonr*latr),kmsk0(lonr*latr),kmskcv(lonr*latr),nblck
!     real (kind=kind_io8)
...
!    &     CUMFLX(NGPTC,LEVS,NBLCK,lats_node_r),
!    &     CLDCOV(LEVS,LONR,LATS_NODE_R), PSURF(LONR,LATS_NODE_R)
!
       ...
       do k=1,levs
        ...
        do lan=1,LATS_NODE_R
         ...
         DO lon=1,lons_lat,NGPTC
          ...
          iblk=iblk+1
          do i=1,NJEFF
!           glolal(il,lan) = CUMFLX(i,k,iblk,lan)* RTIME
