...
!
      INTEGER :: NREC=0    
!
      INTEGER :: JCAP,IDVC,IDVM,IDSL,IDRT,NVCOORD,NSOIL
!
...
!
      JCAP=-9999;IDVC=-9999;IDVM=-9999;IDSL=-9999;IDRT=-9999;NVCOORD=-9999
      NSOIL=-9999;GEN_COORD_HYBRID=.false.;HYBRID=.false.
!
