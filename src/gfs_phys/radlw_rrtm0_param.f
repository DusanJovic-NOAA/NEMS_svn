...
!       'rlwinit'   -- to initialize rrtm0 lw radiation                !
!                                                                      !
...
!
        ...
        parameter ( iaerlw=0 )      !===> ... control flag for aerosols (not yet)
                        !(default)  ! =0: do not include aerosol effect
                                    ! =1: include aerosol effect (not in current version)

        parameter ( irgaslw=0 )     !===> ... control flag for rare gases (ch4,n2o,o2, etc.)
                        !(default)  ! =0: do not include rare gases
                                    ! =1: include all rare gases

        parameter ( icfclw=0  )     !===> ... control flag for halocarbon (cfc) gases
...
!  ---  band spectrum structures (wavenumber in cm**-1)
      real (kind=kind_phys) :: wvnum1(NBANDS), wvnum2(NBANDS)
      data wvnum1  /                                                    &
