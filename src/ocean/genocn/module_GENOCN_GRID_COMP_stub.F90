...
#else
      CALL ESMF_GridCompSetEntryPoint(GENOCN_GRID_COMP ,ESMF_METHOD_INITIALIZE ,GENOCN_INITIALIZE ,phase=ESMF_SINGLEPHASE ,rc=RC)
      CALL ESMF_GridCompSetEntryPoint(GENOCN_GRID_COMP ,ESMF_METHOD_RUN        ,GENOCN_RUN        ,phase=ESMF_SINGLEPHASE ,rc=RC)
      CALL ESMF_GridCompSetEntryPoint(GENOCN_GRID_COMP ,ESMF_METHOD_FINALIZE   ,GENOCN_FINALIZE   ,phase=ESMF_SINGLEPHASE ,rc=RC)
#endif
