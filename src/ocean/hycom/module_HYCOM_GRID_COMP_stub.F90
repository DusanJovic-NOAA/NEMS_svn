...
#else
      CALL ESMF_GridCompSetEntryPoint(HYCOM_GRID_COMP ,ESMF_METHOD_INITIALIZE ,HYCOM_INITIALIZE ,phase=ESMF_SINGLEPHASE ,rc=RC)
      CALL ESMF_GridCompSetEntryPoint(HYCOM_GRID_COMP ,ESMF_METHOD_RUN        ,HYCOM_RUN        ,phase=ESMF_SINGLEPHASE ,rc=RC)
      CALL ESMF_GridCompSetEntryPoint(HYCOM_GRID_COMP ,ESMF_METHOD_FINALIZE   ,HYCOM_FINALIZE   ,phase=ESMF_SINGLEPHASE ,rc=RC)
#endif
