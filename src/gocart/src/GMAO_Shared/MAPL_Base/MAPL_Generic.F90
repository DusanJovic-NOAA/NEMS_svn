!  $Id: MAPL_Generic.F90,v 1.38.2.1.4.1 2009/07/20 16:57:29 dasilva Exp $
...
! !IROUTINE: MAPL_StateAddImportSpec_
...
! !INTERFACE:
  ...
  subroutine MAPL_StateAddImportSpec_(GC, SHORT_NAME, LONG_NAME,             &
                                     ...
                                     HALOWIDTH, DEFAULT, NORESTART, RC)
...
! !IROUTINE: MAPL_StateAddExportSpec_
...
!!!       call MAPL_CFIOStateRead(FILE=FNAME, CLOCK=CLOCK, STATE=STATE, RC=STATUS)
       STATUS = -1 ! not yet
       VERIFY_(STATUS)
    endif
