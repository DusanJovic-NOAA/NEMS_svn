...
!-----------------------------------------------------------------------
!
      type(esmf_cplcomp),intent(inout) :: gc_gfs_cpl 	! coupler component
!
...
!-----------------------------------------------------------------------
!
      subroutine gfs_cpl_run(gc_gfs_cpl,imp_state,exp_state                &
                             ,clock,rc_cpl)
!
!-----------------------------------------------------------------------
!-----------------------------------------------------------------------
...
!
      ...
      if( trim(import_statename).eq.'physics export'  .and.             &
          trim(export_statename).eq.'GFS dynamics import' .and.         &
          from_exp_phy_to_imp_dyn ) return

      if( trim(import_statename).eq.'GFS dynamics import' .and.         &
          trim(export_statename).eq.'GFS dynamics export' .and.         &
...
!-----------------------------------------------------------------------
!
      subroutine gfs_cpl_finalize(gc_gfs_cpl,imp_state,exp_state           &
                                  ,clock,rc_cpl)
!
!-----------------------------------------------------------------------
