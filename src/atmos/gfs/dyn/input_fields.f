...
!
      ...
      CALL TREADEO_nemsio(IDATE,trie_ls,trio_ls,
...
!       print *,' set time level n to time level n-1 '
       ...
       trie_ls(:,:,P_q )=trie_ls(:,:,P_qm )
       trie_ls(:,:,p_dp:p_dp+levs-1)=trie_ls(:,:,p_dpm:p_dpm+levs-1)
       trie_ls(:,:,p_te:p_te+levs-1)=trie_ls(:,:,p_tem:p_tem+levs-1)
       trie_ls(:,:,p_di:p_di+levs-1)=trie_ls(:,:,p_dim:p_dim+levs-1)
       trie_ls(:,:,p_ze:p_ze+levs-1)=trie_ls(:,:,p_zem:p_zem+levs-1)
       trio_ls(:,:,P_q )=trio_ls(:,:,P_qm )
       trio_ls(:,:,p_dp:p_dp+levs-1)=trio_ls(:,:,p_dpm:p_dpm+levs-1)
       trio_ls(:,:,p_te:p_te+levs-1)=trio_ls(:,:,p_tem:p_tem+levs-1)
       trio_ls(:,:,p_di:p_di+levs-1)=trio_ls(:,:,p_dim:p_dim+levs-1)
       trio_ls(:,:,p_ze:p_ze+levs-1)=trio_ls(:,:,p_zem:p_zem+levs-1)

       if( .not. ndslfv ) then
         trie_ls(:,:,p_rq:p_rq+levh-1)=trie_ls(:,:,p_rm:p_rm+levh-1)
         trio_ls(:,:,p_rq:p_rq+levh-1)=trio_ls(:,:,p_rm:p_rm+levh-1)
       endif
! grid
        grid_gr(:,:,g_q )=grid_gr(:,:,g_qm )
        grid_gr(:,:,g_dp:g_dp+levs-1)=grid_gr(:,:,g_dpm:g_dpm+levs-1)
