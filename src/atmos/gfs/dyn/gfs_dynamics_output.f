...
!jw
      PUBLIC :: DYN_INT_STATE_ISCALAR, DYN_INT_STATE_RSCALAR,           &
...
!-------------------------
!
      CHARACTER(16),DIMENSION(3,MAX_KOUNT) :: DYN_INT_STATE_ISCALAR     &
!
       =RESHAPE((/                                                      &
!                              -----------------------------------------
!
...
!----------------------
!
      CHARACTER(16),DIMENSION(3,MAX_KOUNT) :: DYN_INT_STATE_RSCALAR     &  
!
       =RESHAPE((/                                                      &
!                              -----------------------------------------
!
...
!
       ...
       use gfs_dyn_coordinate_def, only: vertcoord_id                  &
               ,AK5,BK5,CK5
...
!*** (int_state%lonf,int_state%lats_node_a_max)
     ...
     print*,'lonf=',int_state%lonf,'lats_node_a_max=',int_state%lats_node_a_max, &
...
!
      ...
      I_SC(9)%NAME=>vertcoord_id
      I_SC(10)%NAME=>thermodyn_id
      I_SC(11)%NAME=>sfcpress_id
      I_SC(12)%NAME=>ienst
      I_SC(13)%NAME=>iensi
      I_SC(14)%NAME=>itrun
      I_SC(15)%NAME=>icen2
...
!-----------------------------------------------------------------------
!
      CALL ADD_BUNDLE_TO_WRITE(int_state,imp_state_write,     &
           grid,I_SC,R_SC,L_SC,I_1D,R_1D,R_2D,R_3D,             &
...
!-----------------------------------------------------------------------
!
      SUBROUTINE ADD_BUNDLE_TO_WRITE(int_state,imp_state_write,          &
                   GRID,I_SC,R_SC,L_SC,I_1D,R_1D,R_2D,R_3D,              &
...
!jw!           CALL ESMF_LogWrite(MESSAGE_CHECK,ESMF_LOG_INFO,rc=RC)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
