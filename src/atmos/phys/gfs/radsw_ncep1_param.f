...
!
        ...
        parameter ( ibndsw=1 )      !===> ... band selections in nir spectrum
                                    ! =0: faster computation, use 1 nir band
                        ! (default) ! =1: better accuracy,    use 3 nir bands

        parameter ( iflagc=2 )      !===> ... flag for cloud property method
                                    ! =0: input cloud opt depth, fixed ssa, asy
                                    ! =1: input cwp/cip, t-adj coeff for all bands
                        ! (default) ! =2: input cwp/cip, chou (1999) coeff for uv
