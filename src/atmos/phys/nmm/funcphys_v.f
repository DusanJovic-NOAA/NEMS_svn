...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
! Public Subprograms
  public n_gpvsl,n_fpvsl,n_fpvslq,n_fpvslx
  public n_gpvsi,n_fpvsi,n_fpvsiq,n_fpvsix
  public n_gpvs,n_fpvs,n_fpvsq,n_fpvsx
  public n_gtdpl,n_ftdpl,n_ftdplq,n_ftdplx,n_ftdplxg
  public n_gtdpi,n_ftdpi,n_ftdpiq,n_ftdpix,n_ftdpixg
  public n_gtdp,n_ftdp,n_ftdpq,n_ftdpx,n_ftdpxg
  public n_gthe,n_fthe,n_ftheq,n_fthex
  public n_gtma,n_stma,n_stmaq,n_stmax,n_stmaxg
  public n_gpkap,n_fpkap,n_fpkapq,n_fpkapo,n_fpkapx
  public n_grkap,n_frkap,n_frkapq,n_frkapx
  public n_gtlcl,n_ftlcl,n_ftlclq,n_ftlclo,n_ftlclx
  public n_gfuncphys
contains
!-------------------------------------------------------------------------------
  subroutine n_gpvsl
...
!   c1xpvsl=1.-xmin/xinc
    ...
    do jx=1,nxpvsl
      x=xmin+(jx-1)*xinc
      t=x
      tbpvsl(jx)=n_fpvslx(t)
    enddo
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end subroutine
!-------------------------------------------------------------------------------
  elemental function n_fpvsl(t)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    n_fpvsl=tbpvsl(jx)+(xj-jx)*(tbpvsl(jx+1)-tbpvsl(jx))
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_fpvslq(t)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    fj2=tbpvsl(jx)
    fj3=tbpvsl(jx+1)
    n_fpvslq=(((fj3+fj1)/2-fj2)*dxj+(fj3-fj1)/2)*dxj+fj2
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_fpvslx(t)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    tr=con_ttp/t
    n_fpvslx=con_psat*(tr**xpona)*exp(xponb*(1.-tr))
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  subroutine n_gpvsi
...
!   c1xpvsi=1.-xmin/xinc
    ...
    do jx=1,nxpvsi
      x=xmin+(jx-1)*xinc
      t=x
      tbpvsi(jx)=n_fpvsix(t)
    enddo
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end subroutine
!-------------------------------------------------------------------------------
  elemental function n_fpvsi(t)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    n_fpvsi=tbpvsi(jx)+(xj-jx)*(tbpvsi(jx+1)-tbpvsi(jx))
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_fpvsiq(t)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    fj2=tbpvsi(jx)
    fj3=tbpvsi(jx+1)
    n_fpvsiq=(((fj3+fj1)/2-fj2)*dxj+(fj3-fj1)/2)*dxj+fj2
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_fpvsix(t)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    tr=con_ttp/t
    n_fpvsix=con_psat*(tr**xpona)*exp(xponb*(1.-tr))
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  subroutine n_gpvs
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    n_fpvs=tbpvs(jx)+(xj-jx)*(tbpvs(jx+1)-tbpvs(jx))
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_fpvsq(t)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    fj2=tbpvs(jx)
    fj3=tbpvs(jx+1)
    n_fpvsq=(((fj3+fj1)/2-fj2)*dxj+(fj3-fj1)/2)*dxj+fj2
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_fpvsx(t)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    tr=con_ttp/t
    if(t.ge.tliq) then
      n_fpvsx=con_psat*(tr**xponal)*exp(xponbl*(1.-tr))
    elseif(t.lt.tice) then
      n_fpvsx=con_psat*(tr**xponai)*exp(xponbi*(1.-tr))
    else
      w=(t-tice)/(tliq-tice)
      pvl=con_psat*(tr**xponal)*exp(xponbl*(1.-tr))
      pvi=con_psat*(tr**xponai)*exp(xponbi*(1.-tr))
      n_fpvsx=w*pvl+(1.-w)*pvi
    endif
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    n_ftdpl=tbtdpl(jx)+(xj-jx)*(tbtdpl(jx+1)-tbtdpl(jx))
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_ftdplq(pv)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    fj2=tbtdpl(jx)
    fj3=tbtdpl(jx+1)
    n_ftdplq=(((fj3+fj1)/2-fj2)*dxj+(fj3-fj1)/2)*dxj+fj2
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_ftdplx(pv)
!$$$     Subprogram Documentation Block
!
...
!$$$
    implicit none
    real(krealfp) n_ftdplx
    real(krealfp),intent(in):: pv
    real(krealfp) tg
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    tg=n_ftdpl(pv)
    n_ftdplx=n_ftdplxg(tg,pv)
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_ftdplxg(tg,pv)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    n_ftdpi=tbtdpi(jx)+(xj-jx)*(tbtdpi(jx+1)-tbtdpi(jx))
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_ftdpiq(pv)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    fj2=tbtdpi(jx)
    fj3=tbtdpi(jx+1)
    n_ftdpiq=(((fj3+fj1)/2-fj2)*dxj+(fj3-fj1)/2)*dxj+fj2
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_ftdpix(pv)
!$$$     Subprogram Documentation Block
!
...
!$$$
    implicit none
    real(krealfp) n_ftdpix
    real(krealfp),intent(in):: pv
    real(krealfp) tg
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    tg=n_ftdpi(pv)
    n_ftdpix=n_ftdpixg(tg,pv)
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_ftdpixg(tg,pv)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    n_ftdp=tbtdp(jx)+(xj-jx)*(tbtdp(jx+1)-tbtdp(jx))
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_ftdpq(pv)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    fj2=tbtdp(jx)
    fj3=tbtdp(jx+1)
    n_ftdpq=(((fj3+fj1)/2-fj2)*dxj+(fj3-fj1)/2)*dxj+fj2
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_ftdpx(pv)
!$$$     Subprogram Documentation Block
!
...
!$$$
    implicit none
    real(krealfp) n_ftdpx
    real(krealfp),intent(in):: pv
    real(krealfp) tg
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    tg=n_ftdp(pv)
    n_ftdpx=n_ftdpxg(tg,pv)
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_ftdpxg(tg,pv)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    do jy=1,nythe
      ...
      do jx=1,nxthe
        x=xmin+(jx-1)*xinc
        t=x
        tbthe(jx,jy)=n_fthex(t,pk)
      enddo
    enddo
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end subroutine
!-------------------------------------------------------------------------------
  elemental function n_fthe(t,pk)
!$$$     Subprogram Documentation Block
!
...
!-------------------------------------------------------------------------------
  elemental function n_ftheq(t,pk)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    if(xj.ge.1..and.yj.ge.1.) then
      ...
      n_ftheq=(((ftx3+ftx1)/2-ftx2)*dyj+(ftx3-ftx1)/2)*dyj+ftx2
    else
      n_ftheq=0.
    endif
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
!-------------------------------------------------------------------------------
! elemental function n_fthex(t,pk)
            function n_fthex(t,pk)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    if(pd.gt.pv) then
      ...
      n_fthex=t*pd**(-con_rocp)*exp(expo)
    else
      n_fthex=0.
    endif
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
!-------------------------------------------------------------------------------
  elemental subroutine n_stma(the,pk,tma,qma)
!$$$     Subprogram Documentation Block
!
...
!-------------------------------------------------------------------------------
  elemental subroutine n_stmaq(the,pk,tma,qma)
!$$$     Subprogram Documentation Block
!
...
!-------------------------------------------------------------------------------
  elemental subroutine n_stmax(the,pk,tma,qma)
!$$$     Subprogram Documentation Block
!
...
!$$$
    ...
    real(krealfp) tg,qg
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    call n_stma(the,pk,tg,qg)
    call n_stmaxg(tg,the,pk,tma,qma)
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end subroutine
!-------------------------------------------------------------------------------
  elemental subroutine n_stmaxg(tg,the,pk,tma,qma)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    do jx=1,nxpkap
      x=xmin+(jx-1)*xinc
      p=x
      tbpkap(jx)=n_fpkapx(p)
    enddo
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end subroutine
!-------------------------------------------------------------------------------
  elemental function n_fpkap(p)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    n_fpkap=tbpkap(jx)+(xj-jx)*(tbpkap(jx+1)-tbpkap(jx))
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_fpkapq(p)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    fj2=tbpkap(jx)
    fj3=tbpkap(jx+1)
    n_fpkapq=(((fj3+fj1)/2-fj2)*dxj+(fj3-fj1)/2)*dxj+fj2
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  function n_fpkapo(p)
...
!$$$
    implicit none
    real(krealfp) n_fpkapx
    real(krealfp),intent(in):: p
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    n_fpkapx=(p/1.e5_krealfp)**con_rocp
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  subroutine n_grkap
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    do jx=1,nxrkap
      x=xmin+(jx-1)*xinc
      p=x
      tbrkap(jx)=n_frkapx(p)
    enddo
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end subroutine
!-------------------------------------------------------------------------------
  elemental function n_frkap(pkap)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    n_frkap=tbrkap(jx)+(xj-jx)*(tbrkap(jx+1)-tbrkap(jx))
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_frkapq(pkap)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    fj2=tbrkap(jx)
    fj3=tbrkap(jx+1)
    n_frkapq=(((fj3+fj1)/2-fj2)*dxj+(fj3-fj1)/2)*dxj+fj2
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_frkapx(pkap)
!$$$   Subprogram  documentation  block
!
...
!$$$
    implicit none
    real(krealfp) n_frkapx
    real(krealfp),intent(in):: pkap
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    n_frkapx=pkap**(1/con_rocp)*1.e5_krealfp
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  subroutine n_gtlcl
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    do jy=1,nytlcl
      ...
      do jx=1,nxtlcl
        x=xmin+(jx-1)*xinc
        t=x
        tbtlcl(jx,jy)=n_ftlclx(t,tdpd)
      enddo
    enddo
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end subroutine
!-------------------------------------------------------------------------------
  elemental function n_ftlcl(t,tdpd)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    n_ftlcl=ftx1+(yj-jy)*(ftx2-ftx1)
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_ftlclq(t,tdpd)
!$$$     Subprogram Documentation Block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    ftx2=(((ft32+ft12)/2-ft22)*dxj+(ft32-ft12)/2)*dxj+ft22
    ftx3=(((ft33+ft13)/2-ft23)*dxj+(ft33-ft13)/2)*dxj+ft23
    n_ftlclq=(((ftx3+ftx1)/2-ftx2)*dyj+(ftx3-ftx1)/2)*dyj+ftx2
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  function n_ftlclo(t,tdpd)
!$$$   Subprogram  documentation  block
!
...
!$$$
    implicit none
    real(krealfp) n_ftlclo
    real(krealfp),intent(in):: t,tdpd
    real(krealfp),parameter:: clcl1= 0.954442e+0,clcl2= 0.967772e-3,&
                                    clcl3=-0.710321e-3,clcl4=-0.270742e-5
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    n_ftlclo=t-tdpd*(clcl1+clcl2*t+tdpd*(clcl3+clcl4*t))
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  elemental function n_ftlclx(t,tdpd)
!$$$   Subprogram  documentation  block
!
...
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    enddo
    n_ftlclx=max(tlcl,tlmin)
! - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
  end function
!-------------------------------------------------------------------------------
  subroutine n_gfuncphys
!$$$     Subprogram Documentation Block
!
