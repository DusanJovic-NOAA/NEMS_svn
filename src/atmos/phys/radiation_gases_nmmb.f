...
!     mar 2012 - y-t hou     modified subr getozn.  moved the if-first !
...
!     ICO2    - co2 data control flag                       1           !
!               =0: use prescribed global mean co2 (old opernl)         !
!               =1: use observed or provided(ICTM=-1) co2 global annual !
!                   mean value                                          !
!               =2: use observed or provided(ICTM=-1) co2 monthly data  !
!                   with 2-d variation                                  !
!     IOZN    - ozone data control flag                     1           !
!               =0: use climatological ozone profile                    !
!               >0: use interactive ozone profile                       !
!    iflip    - control flag for vertical index direction   1           !
...
!                                                                       !
!  module variables:                                                    !
!     lclimoz    - control flag for climatology ozone                   !
!     ico2flg    - control flag for co2 data                            !
!     ictmflg    - control flag for ic time data set                    !
!     ivflip     - control flag for vertical direction                  !
...
!         print *,' O3=',(o3r(15,k,1),k=1,LOZ)
        ...
        do k = 1, LOZ
           if ( pstr(k) >= 0.1 ) then
              pkstr(k) = fpkap(pstr(k)*100.0)
           else
              pkstr(k) = (pstr(k)/1000.)**(con_rocp)
           endif
        enddo
...
!  module variables:                                                    !
!     lclimoz    - control flag for climatology ozone                   !
!     ico2flg    - control flag for co2 data form                       !
!     ictmflg    - ic time data control flag                            !
!     ivflip     - vertical indexing control flag                       !
...
!  by control flag 'iflip'   ---  Apr. 03,  y-t hou                     !
!                                                                       !
!  inputs:                                                              !
...
!
!.............................................!
      end module module_radiation_gases_nmmb  !
!=============================================!
