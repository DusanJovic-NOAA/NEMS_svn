...
!***  routines.  They are called from the NMM gridded component
!***  (NMM Initialize calls Physics Initialize, etc.) 
!***  IN module_NMM_GRID_COMP.F90.
!
!-----------------------------------------------------------------------
!
! HISTORY LOG:
...
!
!-----------------------------------------------------------------------
!***  Carry out all necessary setups for the Physics component.
!-----------------------------------------------------------------------
!
!------------------------
!***  Argument variables
