...
,jhalo                  ! number of halo rows in j direction
!
      real,dimension(ims:ime,jms:jme,ll1),intent(inout) :: &
!
 arr1                   ! array whose haloes are exchanged
!
!
...
!
      real,dimension(ims:ime,jms:jme,ll2),intent(inout) :: &
...
,arr2                   ! 2-D array whose haloes are exchanged
!
      real,dimension(ims:ime,jms:jme,ll3),intent(inout) :: &
...
!
 ...
 arr3                   ! 3-D array whose haloes are exchanged
!
      real,dimension(ims:ime,jms:jme,ll4),intent(inout) :: &
 arr4                   ! 3-D array whose haloes are exchanged
!
      real,dimension(ims:ime,jms:jme,ll5),intent(inout) :: &
...
,jhalo                  ! number of halo rows in j direction
!
      real,dimension(ims:ime,jms:jme,ll1,nl1),intent(inout) :: &
!
 arr1                   ! array whose haloes are exchanged
!
!-----------------------------------------------------------------------
